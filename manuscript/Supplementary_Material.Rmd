...
Lo que entendemos por especies vegetales y si éstas tienen alguna realidad biológica ha sido objeto de debate por años en la biología evolutiva. En este estudio abordamos esta pregunta integrando datos fenómicos y genómicos en _Escallonia_, un grupo de árboles y arbustos distribuidos en las montañas de Suramérica. Contrario a la creencia común, mostramos que las especies taxonómicas tienen poco poder para capturar los patrones de variación presentes en la naturaleza y tienen poca congruencia con las especies delimitadas utilizando métodos estadísticos basados en modelos evolutivos para datos fenotípicos y genéticos. También mostramos que, aunque las especies vegetales existen como una propiedad objetiva de la naturaleza, los datos fenómicos y genómicos no siempre delimitan las mismas entidades. El discernimiento de las causas de estas discordancias merece más estudios detallados utilizando fuentes de información adicionales; sin embargo, nuestros resultados corroboran la necesidad de enfoques que integren múltiples evidencias disponibles para determinar la realidad de las especies vegetales y responder a preguntas fundamentales sobre la naturaleza de las mismas.
